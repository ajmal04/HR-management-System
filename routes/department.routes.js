...
router.put('/:id', withAuth.verifyToken, withAuth.withHigherRoles, department.update);

//  Delete a Department with an ID (Only Admin)
router.delete('/:id', withAuth.verifyToken, withAuth.withHigherRoles, department.delete);

//  Delete all Departments (Only Admin)
router.delete('/', withAuth.verifyToken, withAuth.withHigherRoles, department.deleteAll);

// Retrieve college wise Departments (Admins Department)
router.get('/admin', withAuth.verifyToken, withAuth.withAdmin, department.getDepartmentsByCollege);
