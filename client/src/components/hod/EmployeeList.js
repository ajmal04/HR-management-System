                ...
                <MaterialTable 
                  columns={[
                    ...
                    {title: 'Department', field: 'department.departmentName'},
                    {
                      ...
                      field: 'jobs',
                      render: rowData => {
                        if (!rowData.jobs || !rowData.jobs.length) return 'N/A';
                        ...
                        return currentJob ? currentJob.jobTitle : 'N/A';
                      }
                    },
                    {
                      title: 'Mobile',
                    ...
                    },
                    {
                      ...
                      render: rowData => (
                        <Form inline>
                          <Button size="sm" variant="info" onClick={this.onView(rowData)}>
                            <i className="far fa-address-card"></i>
                          </Button>
                          <Button className="ml-2" size="sm" variant="info" onClick={this.onSalaryView(rowData)}>
