...
export default class ApplicationList extends Component {
  ...
  confirmStatusChange = () => {
    ...
    .catch((err) => {
      this.setState({
        hasError: true,
        errorMsg: err.response?.data?.message || `Failed to ${currentAction} application`,
        isLoading: false
      });
    });
  };
  ...
  render() {
    ...
    return (
      <div className="container-fluid pt-5">
                  ...
                  <MaterialTable
                    columns={[
                      ...
                      },
                      {
                        title: 'Action',
                        render: (rowData) => (
                          rowData.user.id !== currentUserId && rowData.status === "Pending" && (
                            <div className="d-flex">
                              <Button 
                                onClick={() => this.handleStatusChange('approve', rowData)} 
                              ...
                              <Button 
                                onClick={() => this.handleStatusChange('reject', rowData)} 
        ...
        {/* Confirmation Modal */}
        <Modal show={this.state.showConfirmModal} onHide={this.cancelStatusChange}>
          <Modal.Header closeButton>
            <Modal.Title>Confirm Action</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            Are you sure you want to {this.state.currentAction} this application?
          </Modal.Body>
          <Modal.Footer>
            ...
            <Button 
              variant={this.state.currentAction === 'approve' ? "success" : "danger"} 
