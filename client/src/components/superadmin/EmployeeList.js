...
export default class EmployeeList extends Component {
  ...
  handleOnboardingConfirm = async () => {
    try {
      ...
      if (!hasPermission) {
        this.setState({
          error:
            "You don't have permission to create onboarding requests. Please contact an administrator.",
        });
  ...
  render() {
    ...
    const closeOnboardingConfirmModal = () =>
      this.setState({ onboardingConfirmModal: false });
      ...
      <div className="container-fluid pt-4">
        ...
        {this.state.deleteModal && (
          <DeleteModal
            ...
            onDeleteSuccess={this.refreshEmployeeList}
          />
        )}
        {this.state.onboardingConfirmModal && (
          <Modal show={true} onHide={closeOnboardingConfirmModal}>
            ...
            <Modal.Body>
              Are you sure you want to create an onboarding request for{" "}
              ...
              <ThemeProvider theme={theme}>
                <MaterialTable
                  ...
                  options={{
                    ...
                    sorting: true,
                    draggable: false,
                    emptyStateMessage: this.state.loading
                      ? "Loading..."
                      : "No employees found",
                    cellStyle: {
                      padding: "8px 16px",
