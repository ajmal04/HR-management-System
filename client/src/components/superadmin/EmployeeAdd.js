...
export default class EmployeeAdd extends Component {
  ...
  validateStep = (step) => {
    ...
    switch (step) {
      ...
      case 3:
        ...
        console.log(
          "Contact details validation errors:",
      ...
      case 4:
        ...
        break;
      case 5:
        errors.qualificationDetails = validateQualificationDetails(
          formData.qualificationDetails
        );
        console.log(
          "Qualification details validation errors:",
      ...
      case 6:
        ...
        console.log(
          "Official status validation errors:",
          errors.officialStatus
        );
        break;
    }
  ...
  validateAllSteps = () => {
    const errors = {
      ...
      contactDetails: validateContactDetails(
        this.state.formData.contactDetails
      ),
      bankInfo: validateBankInfo(this.state.formData.bankInfo),
      qualificationDetails: validateQualificationDetails(
        this.state.formData.qualificationDetails
      ),
      officialStatus: validateOfficialStatus(
  ...
  renderStepIndicator = () => {
    const progress =
      (this.state.ui.currentStep / this.state.ui.totalSteps) * 100;
    const steps = [
        ...
        <div className="steps-container">
          {steps.map((step) => (
            <div
              key={step.number}
              className={`step ${
                this.state.ui.currentStep >= step.number ? "active" : ""
              }`}
            >
          ...
          <div className="col-md-6">
            {this.renderFormGroup(
              ...
              <DatePicker
                ...
                onChange={(date) =>
                  this.handleDateChange(date, "personalInfo.dateOfBirth")
                }
                showMonthDropdown
                showYearDropdown
                dropdownMode="select"
            ...
            {governmentIds.aadharCard && (
              <div className="file-selected mt-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    this.handleFileRemove("governmentIds", "aadharCard")
                  }
                >
                ...
                {governmentIds.panCard && (
                  <div className="file-selected mt-2">
                    ...
                    <Button
                      ...
                      className="text-danger ml-2"
                      onClick={() =>
                        this.handleFileRemove("governmentIds", "panCard")
                      }
                    >
                      <i className="fas fa-times"></i>
                    </Button>
                ...
                {governmentIds.passport && (
                  <div className="file-selected mt-2">
                    ...
                    <Button
                      ...
                      className="text-danger ml-2"
                      onClick={() =>
                        this.handleFileRemove("governmentIds", "passport")
                      }
                    >
                      <i className="fas fa-times"></i>
                    </Button>
              ...
              <div>
                ...
                {governmentIds.drivingLicenseDoc && (
                  <div className="file-selected mt-2">
                    <i className="fas fa-check-circle text-success mr-2"></i>
                    Selected:{" "}
                    {this.getFileName(governmentIds.drivingLicenseDoc)}
                    <Button
                      variant="link"
                      size="sm"
                      className="text-danger ml-2"
      ...
      <FormStep title="Qualification Details">
        ...
        <div className="certifications-section">
          ...
          {qualificationDetails.certifications.map((cert, index) => (
            <div
              key={index}
              className="certification-item mb-3 p-3 border rounded"
            >
              <div className="row">
                <div className="col-md-6">
                  {this.renderFormGroup(
                ...
                <div className="col-md-4">
                  {this.renderFormGroup(
                    ...
                    <DatePicker
                      ...
                      onChange={(date) =>
                        this.handleCertificationChange(index, "issueDate", date)
                      }
                      dateFormat="yyyy-MM-dd"
                      className="form-control"
            ...
            <div>
              ...
              {qualificationDetails.educationalCertificates?.length > 0 && (
                <div className="files-selected mt-2">
                  <i className="fas fa-check-circle text-success mr-2"></i>
                  Selected:{" "}
                  {qualificationDetails.educationalCertificates.length} file(s)
                  <Button
                    variant="link"
                    size="sm"
                    className="text-danger ml-2"
          ...
          <div className="col-md-6">
            {this.renderFormGroup(
              ...
              <DatePicker
                ...
                onChange={(date) =>
                  this.handleDateChange(date, "officialStatus.joiningDate")
                }
                dateFormat="yyyy-MM-dd"
                className="form-control"
          ...
          <div className="col-md-6">
            {this.renderFormGroup(
              ...
              <DatePicker
                ...
                onChange={(date) =>
                  this.handleDateChange(date, "officialStatus.startDate")
                }
                dateFormat="yyyy-MM-dd"
                className="form-control"
          ...
          <div className="col-md-6">
            {this.renderFormGroup(
              ...
              <DatePicker
                ...
                onChange={(date) =>
                  this.handleDateChange(date, "officialStatus.endDate")
                }
                dateFormat="yyyy-MM-dd"
                className="form-control"
          ...
          {this.renderFormGroup(
            ...
            <div>
              ...
              {officialStatus.experienceCertificates?.length > 0 && (
                <div className="files-selected mt-2">
                  <i className="fas fa-check-circle text-success mr-2"></i>
                  Selected: {officialStatus.experienceCertificates.length}{" "}
                  file(s)
                  <Button
                    variant="link"
                    size="sm"
  ...
  hasDocumentsToUpload = () => {
    const { governmentIds, qualificationDetails, officialStatus } =
      this.state.formData;
    return (
      governmentIds.aadharCard ||
      governmentIds.panCard ||
      governmentIds.passport ||
      governmentIds.drivingLicenseDoc ||
      (qualificationDetails.educationalCertificates &&
        qualificationDetails.educationalCertificates.length > 0) ||
      (officialStatus.experienceCertificates &&
        officialStatus.experienceCertificates.length > 0)
    );
  };
  ...
  uploadDocuments = async (userId) => {
    ...
    // Append single files
    if (governmentIds.aadharCard)
      formData.append("aadharCard", governmentIds.aadharCard);
    if (governmentIds.panCard)
      formData.append("panCard", governmentIds.panCard);
    if (governmentIds.passport)
      formData.append("passport", governmentIds.passport);
    if (governmentIds.drivingLicenseDoc)
      formData.append("drivingLicense", governmentIds.drivingLicenseDoc);
  ...
  onSubmit = async (e) => {
    ...
    try {
      ...
      const formattedCertifications =
        this.state.formData.qualificationDetails.certifications.map((cert) => ({
          name: cert.name,
      ...
      await axios.post(
        ...
        {
          highestQualification:
            this.state.formData.qualificationDetails.highestQualification,
          university: this.state.formData.qualificationDetails.university,
          graduationYear: parseInt(
            this.state.formData.qualificationDetails.graduationYear
          ),
          ...
          certifications:
            formattedCertifications.length > 0
              ? JSON.stringify(formattedCertifications)
              : null,
          userId: userId,
        },
        {
